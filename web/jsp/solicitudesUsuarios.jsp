<%-- 
    Document   : solicitudesUsuarios
    Created on : Jun 19, 2021, 10:13:50 AM
    Author     : USUARIO
--%>
            ...
            <div class="collapse" style="color: antiquewhite;" id="navbarToggleExternalContent">
                <div class=" p-4" style="background-color: #93291E">
                    ...
                    <ul class="list-group">
                        ...
                        <a href="./IrInicioAdmin.do"> <li class="list-group-item" style="color: antiquewhite; background-color: #93291E">
                                Inicio</li></a>
        ...
        <div class="container d-block justify-content-center">
            ...
            <div class="row d-flex justify-content-center" style="height: 200px;">
                <div class="col-7 rounded shadow-lg"
                    ...
                    <br><br>
                    <form action="./buscarReservas.do" method="get" class="d-flex p-3">
                        <input name="codigo" class="form-control me-2" type="search" placeholder="Codigo de estudiante" aria-label="Search">
            ...
            <!-- solicitudes -->
            <h1 style="color: aliceblue;">Solicitudes</h1>
            <div class="row d-flex justify-content-center rounded" style="background-color: #f3efef33;">

                <%
                    
                String solicitudes = request.getSession().getAttribute("solicitudes").toString();

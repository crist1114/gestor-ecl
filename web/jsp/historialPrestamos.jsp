<%-- 
    Document   : historialPerstamos
    Created on : Jun 19, 2021, 10:10:44 AM
    Author     : USUARIO
--%>
                ...
                <section class="row mt-5 mb-1 shadow-lg p-3  bg-white w-50 d-flex ">
                    ...
                    <div class="col-7 ">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 d-flex justify-content-center mx-0">
                              <a href="./jsp/verPerfil.jsp"> <button type="submit"class="btn btn-danger"> Ver Perfil</button> </a>
                            </div>
                        </div>

                    </div>

                    <h3 class="text-center my-4">Historial</h3>
                    
                    <%
                        String rta = request.getSession().getAttribute("rta").toString();
                    %>
